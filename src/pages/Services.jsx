...
const Services = () => {
    const services = [
        ...
        {
            title: "Référencement",
            icon: <FaMagnifyingGlass className="service-icon" />,
    ...
    return (
        <>
            ...
            <section className="bg-light py-5">
                <Container>
                    <h1 className="display-5 fw-bold text-center mb-2">Mon offre de services</h1>
                            ...
                            <Col key={index} md={4}>
                                <Card className="h-100 border-0 shadow-sm">
                                    ...
                                    <Card.Body className="p-4">
                                        <Card.Title className="fw-bold fs-3 mb-3 text-center">{service.title}</Card.Title>
